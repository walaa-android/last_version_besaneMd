 ...
 * Use the {@link ThirdStepFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ThirdStepFragment extends Fragment {
    TextView textViewStepThree ;
    ...
    public static ThirdStepFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textViewStepThree = v.findViewById(R.id.textViewStepThree);
    ...
    /*    StyleSpan boldSpan = new StyleSpan(android.graphics.Typeface.BOLD );
        ...
        SpannableString str2= new SpannableString("Blood Sample\n");
        ...
        builder.append(str3);
        textViewStepThree.setText( builder, TextView.BufferType.SPANNABLE);
