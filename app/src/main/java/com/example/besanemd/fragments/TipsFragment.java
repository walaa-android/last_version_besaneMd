...
import com.example.besanemd.adapter.TipsAdapter;
...
public class TipsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final TipsAdapter tipsAdapter = new TipsAdapter(getContext(),getActivity().getSupportFragmentManager(), tabLayout.getTabCount());
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
           ...
           //     tabLayout.getTabAt(0).setCustomView(R.drawable.selected_tab);
